...
public class PlayerFieldDropZone : DropZone
{
    public override void OnDrop(PointerEventData eventData){
        ...
        // if (GameManager.Instance.isItFirstTurn)
        // {
        //     GameObject warningPanel = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/WarningPanel.prefab");
        //     Card gettingCard = eventData.pointerDrag.GetComponent<Card>();
        //     gettingCard.transform.position = gettingCard.oldPosition;
        //     GameObject createdPanel = Instantiate(warningPanel,transform.position, Quaternion.identity);
        ...
        // else{
            ...
            createdPanel.transform.SetParent(GameObject.Find("Canvas").transform);
            Button hideButton = GameObject.FindGameObjectWithTag("HideAnswer").GetComponent<Button>();
